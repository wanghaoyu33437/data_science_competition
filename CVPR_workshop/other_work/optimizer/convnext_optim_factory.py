...
def create_optimizer(args, model, get_num_layer=None, get_layer_scale=None, filter_bias_and_bn=True, skip_list=None):
    opt_lower = args['optimizer_name'].lower()
    weight_decay = args['optimizer_hyperparameters']['weight_decay']
    ...
    opt_args = args['optimizer_hyperparameters']
    opt_args['weight_decay'] = weight_decay
    # if 'opt_eps' in args.keys():
    #     opt_args['eps'] = args['opt_eps']
    # if  'opt_betas' in args.keys():
