...
from models.senet import se_resnext50_32x4d, se_resnext101_32x4d, SCSEModule, senet154,se_resnet152
    ...
    'seresnext50':
        {
            ...
            'url':'../premodelweight/se_resnext50_32x4d-a260b3a4.pth'
    ...
    'senet154':
        {
            ...
            'decoder_filters': [64, 128, 256, 384],
            'init_op': senet154,
            'url': '../premodelweight/senet154-c7b49a05.pth',
    ...
    'seresnet152':
        {
            ...
            'url': '/home/zhangyc/.cache/torch/hub/checkpoints/se_resnet152-d17c99b7.pth',
        }
}
...
class EncoderDecoder(AbstractModel):
    def __init__(self, num_classes, num_channels=3, encoder_name='resnet34',pretrained=True):
...
class SEUnet(EncoderDecoder):
    def __init__(self, seg_classes=1, backbone_arch='senet154',pretrained=True):
        self.first_layer_stride_two = True
        super().__init__(seg_classes, num_channels=3, encoder_name=backbone_arch,pretrained=pretrained)
...
class SCSEUnet(SEUnet):
    def __init__(self, seg_classes=1, backbone_arch='seresnext50',pretrained=True):
        self.bottleneck_type = ConvSCSEBottleneckNoBn
        super().__init__(seg_classes, backbone_arch=backbone_arch,pretrained=pretrained)
